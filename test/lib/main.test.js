...
var boardDataFetcher = function boardDataFetcher(board) {
  var boardName = '';
  if (board) {
  ...
  var boardData = sampleBoards[boardName];

  return 'window.__specifiedBoardData__ = ' + JSON.stringify(boardData) + ';';
};

var rotateMatrixClockwise = function rotateMatrixClockwise(matrix, times) {
...
module.exports = {
  ...
  rotateMatrixClockwise: rotateMatrixClockwise,
...
var _require = __webpack_require__(21),
    rotateMatrixClockwise = _require.rotateMatrixClockwise;
 ...
 */
var setCellToBoard = function setCellToBoard(cell) {
  if (!cell) {
    return;
  }
  var row = cell.curRow,
...
var moveBoard = function moveBoard(direction, addRandomCell) {
  var hasMoved = this.moveBoardTowards(direction);
 ...
 */
var moveBoardTowards = function moveBoardTowards(direction) {
  var hasMoved = false;
  switch (direction) {
    case 'up':
 ...
 */
var moveCellsUp = function moveCellsUp() {
  var _this = this;

  var direction = 'up';
  var board = this.getBoard();
  var boardHasMoved = false;
  ...
  for (var j = 0; j < board.length; j++) {
    var _loop = function _loop(i) {
      ...
      var curCell = currentRow[j];
      var preRow = curCell.curRow;
      var merged = false;
      var toRow = _this.getReachableRow(curCell, direction);
      if (toRow > 0 && board[toRow - 1][j] && board[toRow - 1][j].val == curCell.val && !board[toRow - 1][j].shouldNotMergeAgain) {
        _this.mergeTwoCells(board[toRow - 1][j], curCell);
        toRow -= 1;
        merged = true;
      }
      ...
      var cellHasMoved = curCell.fromRow != curCell.curRow;

      var newRow = currentRow.map(function (cell) {
        if (!cell) {
          return;
        }
 ...
 */
var mergeTwoCells = function mergeTwoCells(mergedIntoCell, mergedCell) {
...
var BoardAction = function () {
  function BoardAction() {
    _classCallCheck(this, BoardAction);
  }

  _createClass(BoardAction, [{
    key: 'getMethods',
    value: function getMethods() {
      var utilityAction = [mergeTwoCells, addRandomCell, setCellToBoard];

      var coreMovement = [moveBoardTowards, moveCellsUp, moveBoard];

      var methods = [].concat(utilityAction, coreMovement);

      return methods;
    }
  }, {
    key: 'decorate',
    value: function decorate(boardInstance) {
...
// State/Board
var getReachableRow = function getReachableRow(curCell, direction) {
  var row = curCell.curRow,
      col = curCell.curCol;
  ...
  if (direction == 'up') {
    ...
    for (var _i = row + 1; _i < board.length; _i++) {
      if (board[_i][col]) {
        return _i - 1;
      }
    }
...
// State / Board
var getReachableCol = function getReachableCol(curCell, direction) {
  var row = curCell.curRow,
      col = curCell.curCol;
  ...
  if (direction == 'left') {
    ...
    for (var _i2 = col + 1; _i2 < board.length; _i2++) {
      if (board[row][_i2]) {
        return _i2 - 1;
      }
    }
 ...
 */
var hasMergeableSlots = function hasMergeableSlots() {
  var board = this.board;
  var rowLen = board.length;
  var isMergeable = false;

  for (var i = 0; i < rowLen; i++) {
    var colLen = board[i].length;

    for (var j = 0; j < colLen; j++) {
      var curCell = board[i][j];
      if (j !== colLen - 1) {
        var rightCell = board[i][j + 1];
...
var BoardState = function () {
  ...
  _createClass(BoardState, [{
    key: 'getMethods',
    value: function getMethods() {
      var methods = [getReachableCol, getReachableRow, hasMergeableSlots, isMovable];
...
var AbstractBoard = function () {
  ...
  function AbstractBoard() {
    var boardSize = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 4;

    _classCallCheck(this, AbstractBoard);
    ...
    this.board = (0, _lodash.cloneDeep)(this.grid);
  }
  ...
  _createClass(AbstractBoard, [{
    ...
    value: function print() {
      ...
      var row = this.getBoard().length;
      console.log(message);

      for (var i = 0; i < row; i++) {
        var currentRow = this.getBoard()[i];
        var rowContent = '';
...
var _abstractBoard = __webpack_require__(39);

var _abstractBoard2 = _interopRequireDefault(_abstractBoard);

var _cell = __webpack_require__(41);

var _cell2 = _interopRequireDefault(_cell);

var _boardAction = __webpack_require__(37);

var _boardAction2 = _interopRequireDefault(_boardAction);

var _boardState = __webpack_require__(38);

var _boardState2 = _interopRequireDefault(_boardState);

var _sample_boards = __webpack_require__(29);

var _sample_boards2 = _interopRequireDefault(_sample_boards);
...
var Board = function (_AbstractBoard) {
  _inherits(Board, _AbstractBoard);
   ...
   */
  function Board() {
    var boardData = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    var boardSize = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 4;

    _classCallCheck(this, Board);

    var _this = _possibleConstructorReturn(this, (Board.__proto__ || Object.getPrototypeOf(Board)).call(this, boardSize));

    var decorators = _this.getDecorators();
    _this.hasWon = false;
    _this.hasLost = false;
    _this.score = 0;
    _this.VALUE_4_PROBABILITY = 8; // 8/10 --> 80%

    _this.decorateWith(decorators);
    _this.initWithBoardData(boardData);
    _this.initGrid();
    return _this;
  }
  ...
  _createClass(Board, [{
    key: 'initWithBoardData',
    value: function initWithBoardData(boardData) {
      if (!boardData) {
        return;
      }
      // size of boardData takes precedence
      var rowLen = boardData.length;
      for (var row = 0; row < rowLen; row++) {
        var currentRow = boardData[row];
        var colLen = currentRow.length;
        for (var col = 0; col < colLen; col++) {
          var val = boardData[row][col];
          if (val) {
            var newCell = new _cell2.default(row, col, val);
            this.setCellToBoard(newCell);
          }
        }
      }
    ...
    value: function getDecorators() {
      var actionDecorator = new _boardAction2.default();
      var stateDecorator = new _boardState2.default();
      return [actionDecorator, stateDecorator];
    }
  }, {
    key: 'decorateWith',
    value: function decorateWith(decorators) {
      var _iteratorNormalCompletion = true;
      var _didIteratorError = false;
      var _iteratorError = undefined;
    ...
    key: 'recordCurrentBoard',
    value: function recordCurrentBoard() {
      var currentBoard = this.getBoard();
      var scoreString = '';

      for (var row = 0; row < currentBoard.length; row++) {
        for (var col = 0; col < currentBoard.length; col++) {
          var val = currentBoard[row][col] ? currentBoard[row][col].val : 0;
          scoreString += val + ',';
        }
        scoreString += '!';
      }
    ...
    key: 'fillGridWithEmptyCell',
    value: function fillGridWithEmptyCell() {
      var grid = this.getGrid();
      var rowLen = grid.length;
      for (var i = 0; i < rowLen; i++) {
        var colLen = grid[i].length;
        for (var j = 0; j < colLen; j++) {
          grid[i][j] = new _cell2.default(i, j, 0);
        }
      }
    }
    ...
    key: 'replaceWithTestBoard',
    value: function replaceWithTestBoard() {
      var boardName = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'board_A';

      this.constructor();
      var sampleBoard = _sample_boards2.default[boardName];
      ...
      var rowLen = sampleBoard.length;

      for (var i = 0; i < rowLen; i++) {
        var curRow = sampleBoard[i];
        var colLen = curRow.length;

        for (var j = 0; j < colLen; j++) {
          var val = curRow[j];
          if (val) {
            var cell = new _cell2.default(i, j, val);
    ...
    value: function getRandomCell() {
      var availableSlots = this.getAvailableSlots();
      var availableLength = availableSlots.length;
      ...
      // [0, availableLength - 1]
      var index = ~~(Math.random() * availableLength);
      var slot = availableSlots[index];
      var row = slot.row;
      var col = slot.col;
      var valueFourRand = (0, _utils.getRandomIntInclusive)(0, 10);
      var val = valueFourRand > this.VALUE_4_PROBABILITY ? 4 : 2;
      var newCell = new _cell2.default(row, col, val);
      return newCell;
    }
    ...
    value: function getAvailableSlots() {
      var slots = [];
      var board = this.getBoard();
      var rowLen = board.length;
      ...
      for (var _i2 = 0; _i2 < rowLen; _i2++) {
        var _colLen = board[_i2].length;
        for (var _j = 0; _j < _colLen; _j++) {
          if (slots[_i2][_j] == 0) {
            availableSlots.push({ row: _i2, col: _j });
          }
        }
      }
    ...
    key: 'filterMergedCells',
    value: function filterMergedCells() {
      var board = this.getBoard();
    ...
    key: 'recordMaxScore',
    value: function recordMaxScore() {
      var cookie = document.cookie;
      if (cookie.indexOf('2048-max-score') === -1) {
        document.cookie = '2048-max-score=' + this.score;
      } else {
        var currentMaxScore = +document.cookie.match(/2048-max-score=(\d+)/)[1];
    ...
    */
    ...
    key: 'recordCurrentScore',
    value: function recordCurrentScore() {
...
var Cell = function () {
  ...
  _createClass(Cell, [{
    ...
    key: 'isAt',
    value: function isAt(row, col) {
      return this.curRow == row && this.curCol == col;
    }
  }, {
    key: 'wasAt',
    value: function wasAt(row, col) {
    ...
    key: 'getValueClass',
    value: function getValueClass(val) {
      if (val == 0) {
        return '';
      } else {
        return 'value-' + val;
...
var escapeStringRegexp = __webpack_require__(44);
...
var isSimpleWindowsTerm = process.platform === 'win32' && !/^xterm/i.test(__webpack_require__.i({"NODE_ENV":"production"}).TERM);
...
module.exports = (function () {
	if ('FORCE_COLOR' in __webpack_require__.i({"NODE_ENV":"production"})) {
		return true;
	}
	...
	if ('COLORTERM' in __webpack_require__.i({"NODE_ENV":"production"})) {
		return true;
	}

	if (__webpack_require__.i({"NODE_ENV":"production"}).TERM === 'dumb') {
		return false;
	}

	if (/^screen|^xterm|^vt100|color|ansi|cygwin|linux/i.test(__webpack_require__.i({"NODE_ENV":"production"}).TERM)) {
		return true;
	}
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(73), __webpack_require__(28)(module)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_chai__ = __webpack_require__(207);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_chai___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_chai__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_model_board__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_model_board___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__src_model_board__);
...
describe.only('Board Movement', () => {
  beforeEach(() => {
    this.board = new __WEBPACK_IMPORTED_MODULE_1__src_model_board___default.a();
    global.document = {};
  });
  ...
  describe('Moving up', () => {
    ...
    context('Single cell', () => {
      ...
      it('moves the board correctly', () => {
        ...
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_chai__["expect"])(array).to.deep.equal(expectedBoard);
      });
    });
...
exports.version = __webpack_require__(227).version;

/*!
 * Assertion Error
 */

exports.AssertionError = __webpack_require__(200);
...
var assertion = __webpack_require__(208);
...
var expect = __webpack_require__(211);
exports.use(expect);
...
var should = __webpack_require__(212);
exports.use(should);
...
var assert = __webpack_require__(210);
exports.use(assert);
...
var getEnumerableProperties = __webpack_require__(218);
var config = __webpack_require__(194);
...
var getProperties = __webpack_require__(203);
var isProxyEnabled = __webpack_require__(198);
...
var addLengthGuard = __webpack_require__(196);
var chai = __webpack_require__(193);
var flag = __webpack_require__(192);
var proxify = __webpack_require__(199);
var transferFlags = __webpack_require__(195);
...
var AssertionError = __webpack_require__(200);
var flag = __webpack_require__(192);
...
var flag = __webpack_require__(192)
  , getActual = __webpack_require__(201)
  , inspect = __webpack_require__(197)
  , objDisplay = __webpack_require__(204);
...
var getOwnEnumerablePropertySymbols = __webpack_require__(202);
...
var pathval = __webpack_require__(231);

/*!
 * test utility
 */

exports.test = __webpack_require__(226);
 ...
 * expectTypes utility
 */
exports.expectTypes = __webpack_require__(217);

/*!
 * message utility
 */

exports.getMessage = __webpack_require__(219);

/*!
 * actual utility
 */

exports.getActual = __webpack_require__(201);
...
exports.objDisplay = __webpack_require__(204);
...
exports.transferFlags = __webpack_require__(195);

/*!
 * Deep equal utility
 */

exports.eql = __webpack_require__(229);
...
exports.addMethod = __webpack_require__(214);
...
exports.overwriteMethod = __webpack_require__(224);

/*!
 * Add a chainable method
 */

exports.addChainableMethod = __webpack_require__(213);

/*!
 * Overwrite chainable method
 */

exports.overwriteChainableMethod = __webpack_require__(223);

/*!
 * Compare by inspect method
 */

exports.compareByInspect = __webpack_require__(216);

/*!
 * Get own enumerable property symbols method
 */

exports.getOwnEnumerablePropertySymbols = __webpack_require__(202);

/*!
 * Get own enumerable properties method
 */

exports.getOwnEnumerableProperties = __webpack_require__(220);

/*!
 * Checks error against a given set of criteria
 */

exports.checkError = __webpack_require__(228);

/*!
 * Proxify util
 */

exports.proxify = __webpack_require__(199);

/*!
 * addLengthGuard util
 */

exports.addLengthGuard = __webpack_require__(196);

/*!
 * isProxyEnabled helper
 */

exports.isProxyEnabled = __webpack_require__(198);

/*!
 * isNaN method
 */

exports.isNaN = __webpack_require__(222);
...
var type = __webpack_require__(230);
function FakeMap() {
  this.clear();
}
FakeMap.prototype = {
